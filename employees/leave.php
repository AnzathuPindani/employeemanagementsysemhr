<?php
    ...
    header('location:../index.php');
        ...
        {
      $empid=$_SESSION['eid'];
        $sqlcheck="SELECT sum(DATEDIFF(tblleaves.ToDate, tblleaves.FromDate)) AS date_difference from tblleaves join tblemployees on tblleaves.empid=:empid WHERE YEAR(tblleaves.FromDate) = YEAR(CURDATE())";
        $querycheck = $dbh->prepare($sqlcheck);
        $querycheck->bindParam(':empid',$empid,PDO::PARAM_STR);
        $querycheck->execute();
        $resultchech=$querycheck->fetchColumn();
       $numberofdays=30;
        $res= $numberofdays- $resultchech;
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="leave.php"><img src="../assets/images/logo.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        ...
                        <li class="active">
                            ...
                            <li class="active">
                                <a href="documentslist.php" aria-expanded="true"><i class="ti-book"></i><span>View Documents
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <
                            <h4 class="page-title pull-left">Days Remaining : <?php echo htmlentities(30 - $resultchech); ?></h4>
