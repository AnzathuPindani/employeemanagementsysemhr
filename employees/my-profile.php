<?php
    ...
    if(move_uploaded_file($_FILES['image']['tmp_name'],$target)){
        ...
        $msg ="Some Thing went wrong".$_FILES['image']['tmp_name'];
    } 
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <div class="card">
                                <form name="addemp" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="image" value= <?php echo htmlentities($result->image);?>" type="file">
                                        </div>
