<?php
    ...
    $sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status,image) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status,:image)";
    ...
    if($lastInsertId){
        if(move_uploaded_file($_FILES['image']['tmp_name'],$target)){
            $msg ="Succefully Registered an Employee";
        }else{
            $msg ="Some Thing went wrong".$target;
        } 
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="../assets/images/logo.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <div class="card">
                                <form enctype="multipart/form-data" name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobileno" type="tel"  maxlength="10" autocomplete="off" pattern="^(\+2659|\+2658|09|08)[0-9]{8}$" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Profile Picture</label>
