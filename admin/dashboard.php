        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                    <div class="row">
                        <div class="col-md-4">
                        <a href="document.php" style="color:black">  
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><i class="fa fa-briefcase"></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Number of Documents</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/documents-counter.php'?></h1>
                                        <span>Documents</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                        <a href="employees.php" style="color:black">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <a href="pending-history.php" style="color:black">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                        ...
                        <div class="col-md-4">
                            <a href="declined-history.php" style="color:black">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                        ...
                        <div class="col-md-4">
                        <a href="approved-history.php" style="color:black">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
